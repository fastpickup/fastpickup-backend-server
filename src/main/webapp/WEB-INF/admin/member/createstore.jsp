        ...
        <%@ include file="../include/header.jsp" %>
            ...
            <form action="/admin/member/createstore" method="post">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <input type="text" id="memberName" name="memberName" class="form-control" required placeholder="name is required">
                </div>
                <div class="bg-light rounded h-100 p-4">
                    <label for="email" class="form-label">Email:</label>
                    <input type="email" id="email" name="email" class="form-control" required placeholder="Email is required">
                </div>
                <div class="bg-light rounded h-100 p-4">
                    <label for="memberPw" class="form-label">Password:</label>
                    <input type="password" id="memberPw" name="memberPw" class="form-control" required placeholder="Password is required">
                </div>
                <div class="bg-light rounded h-100 p-4">
