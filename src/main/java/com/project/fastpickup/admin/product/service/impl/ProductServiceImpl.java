...
import com.project.fastpickup.admin.product.exception.ProductNotFoundException;
...
public class ProductServiceImpl implements ProductService {
  ...
  @Override
  public void checkPno(Long pno) {
    if (productMapper.checkPno(pno) == 0) {
      throw new ProductNotFoundException("해당 하는 상품 번호가 없습니다.");
    }
  }
}
